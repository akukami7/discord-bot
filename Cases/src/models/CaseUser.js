...
const caseUserSchema = new mongoose.Schema({
...
caseUserSchema.index({ guildId: 1, userId: 1 }, { unique: true });

export default mongoose.models.CaseUser || mongoose.model('CaseUser', caseUserSchema);
